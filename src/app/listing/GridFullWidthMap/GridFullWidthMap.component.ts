...
@Component({
  selector: 'grid-full-width-map',
  templateUrl: './GridFullWidthMap.component.html',
  styleUrls: ['./GridFullWidthMap.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class GridFullWidthMapComponent implements OnInit{
